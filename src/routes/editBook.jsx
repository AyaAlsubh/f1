...
function editBook() {
  ...
  const baseUrl = `https://server-cb9x.onrender.com/api/books/${urlSlug.slug}`;
  ...
  const createBook = async (e) => {
    ...
    try {
      const response = await fetch("https://server-cb9x.onrender.com/api/books", {
        method: "PUT",
        body: formData,
      });
  ...
  const removeBook = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://server-cb9x.onrender.com/api/books/" + bookId,
        {
          method: "DELETE",
        }
      );
        ...
        <form className="bookdetails" onSubmit={createBook}>
          <div className="col-1">
            ...
            {image ? (
              ...
              <img
                src={`https://server-cb9x.onrender.com/uploads/${thumbnail}`}
                alt="preview image"
              />
            )}
            <input
